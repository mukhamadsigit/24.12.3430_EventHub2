...
@section('page_title', 'Dashboard Penyelenggara')
@section('page_subtitle', 'Kelola event dan pantau statistik penjualan tiket Anda.')
...
@section('content')
    ...
    <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden mb-10">
        <div class="p-8 border-b flex justify-between items-center">
            <h3 class="font-black text-xl">Transaksi Terakhir (Event Saya)</h3>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-8 py-10 text-center text-slate-500">
                                Belum ada transaksi masuk untuk event Anda
                            </td>
                        </tr>
                    @endforelse
                </tbody>
    ...
    {{-- ===================== Summary Cards: Events & Quick Action ===================== --}}
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">

        {{-- Total Events Saya --}}
        <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition flex flex-col justify-between">
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    <p class="text-slate-500 font-medium text-sm">Total Event Saya</p>
            ...
            <div class="flex gap-4">
                ...
                <a href="{{ route('admin.events.create') }}" class="text-emerald-600 font-bold text-xs hover:underline flex items-center gap-1">
                    + Buat Event Baru
                </a>
            </div>
        </div>
        ...
        <div class="bg-indigo-900 rounded-3xl p-8 text-white relative overflow-hidden flex flex-col justify-between">
            <div class="relative z-10">
                ...
                <p class="text-indigo-200 text-sm mb-4">
                    Jika Anda mengalami kesulitan atau kendala dalam memanajemen event Anda, silakan hubungi Support.
                </p>
            </div>
            <div class="flex gap-4 relative z-10">
                <a href="#" class="px-6 py-2.5 bg-white text-indigo-900 rounded-xl font-bold text-xs hover:bg-indigo-50 transition">
                    Hubungi IT Support
                </a>
            </div>
