...
<body class="bg-slate-50 text-slate-900 min-h-screen flex flex-col">
    ...
    <!-- Navigation -->
    <nav class="glass sticky top-8 z-50 mx-4 mt-4 px-6 py-4 rounded-2xl border border-white/20 shadow-lg flex justify-between items-center max-w-7xl lg:mx-auto lg:w-full">
        ...
        <div class="hidden md:flex gap-8 font-medium">
            <a href="{{ route('home') }}" class="{{ request()->routeIs('home') ? 'text-indigo-600' : 'hover:text-indigo-600 transition' }}">Home</a>
